...
if __name__ == "__main__":
    # 数据加载与处理
    df = load_data('F:\站点\植物物候观测数据集20161202\CLIME\clim_carryover_effect_wd2.csv')
    ...
    fig.savefig('F:\站点\植物物候观测数据集20161202\CLIME\wd_sensitivity_heatmap_bottom_colorbar.png', dpi=300, bbox_inches='tight')
    plt.show()