...
# Paths
base_dir = "D:\\MODIS43A4_2024\\EOS2"
...
output_excel_base = "D:\\MOD12Q2\\ratio\\plantclass\\mcd43\\pixel_ratio_results_{}.xlsx"
...
for mask_file in mask_files:
    ...
    for year in range(2001, 2024):  # Include 2023
        file_name = f"masked2_masked_all_EoS_DOY_{year}_masked_tibet.tif"
...
if ratios_all_masks:
    ...
    combined_output_excel = "D:\\MOD12Q2\\ratio\\mcd43\\combined_pixel_ratio_results.xlsx"
