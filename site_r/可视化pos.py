...
# 定义路径
RASTER_DIR = Path(r'D:\MODIS43A4_2024\masked_without_tibet\POS2')
...
RASTER_FILES = {
    'mean_values.tif': {'vmin': 160, 'vmax': 260},
    'std_values.tif': {'vmin': 0, 'vmax': 30},
...
for raster_file, params in RASTER_FILES.items():
    ...
    xlabel = {'mean_values.tif': 'Mean POS (DOY)',
              'std_values.tif': 'Std Values',
              'slope_values.tif': 'POS trend (Days/year)',
