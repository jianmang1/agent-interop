...
RASTER_FILES = {
    'masked2_masked_all_SoS_DOY_2023_masked_tibet.tif': {'vmin': 0, 'vmax': 360},
    'masked2_masked_all_LoS_DOY_2023_masked_tibet.tif': {'vmin': 0, 'vmax': 360},
    'masked2_masked_all_EoS_DOY_2023_masked_tibet.tif': {'vmin': 0, 'vmax': 360},
    'masked2_SOS_MCD12Q2_2023_masked_tibet.tif': {'vmin': 0, 'vmax': 360},
    'masked2_LOS_MCD12Q2_2023_masked_tibet.tif': {'vmin': 0, 'vmax': 360},
    'masked2_EOS_MCD12Q2_2023_masked_tibet.tif': {'vmin': 0, 'vmax': 360},
}
...
def plot_raster_with_histogram(raster_path, output_dir, china_shapefile, vmin=None, vmax=None):
    ...
    with rasterio.open(raster_path) as src:
        ...
        # 添加比例尺
        scale_bar(ax_map, bounds, 1000, 'km', fontsize=24)  # 增大字体大小
...
def setup_map(ax, bounds, china_shapefile):
    ...
    # 设置地图范围
    ax.set_extent([bounds.left, bounds.right, bounds.bottom+2, bounds.top], crs=ccrs.PlateCarree())
...
def add_gridlines(ax):
    ...
    gl.xlabel_style = {'size': 14, 'color': 'black'}  # 调整字体颜色
...
def scale_bar(ax, bounds, length_km, units, fontsize):
    ...
    y_start = bounds.bottom + 0.1 * (bounds.top - bounds.bottom)
