...
# 定义路径
RASTER_DIR = Path(r'D:\MODIS43A4_2024\masked_without_tibet\SOS2')
...
RASTER_FILES = {
    'mean_values.tif': {'vmin': 60, 'vmax': 180},
...
for raster_file, params in RASTER_FILES.items():
    ...
    xlabel = {'mean_values.tif': 'Mean SOS (DOY)',
              'std_values.tif': 'Std Values',
              'slope_values.tif': 'SOS trend (Days/year)',
