...
# 读取csv文件
df = pd.read_csv(r'D:\海拔\2\oth_los_data.csv')

# 删除包含NaN的行
df.dropna(subset=['DEM', 'Oth_LOS'], inplace=True)
...
sns.scatterplot(x='DEM', y='Oth_LOS', color='brown', data=df, s=1, alpha=0.3)  # 设置点的大小为1
