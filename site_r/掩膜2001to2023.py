...
# 定义文件路径
mask_path = r'D:\MODIS43A4_amplitude\SOS500\MODIS43A4_amplitude掩膜\combined_mask.tif'
output_dir = r'D:\MODIS43A4_Value\POS'

# 生成2001年至2023年的文件列表
start_year = 2001
end_year = 2024
files_to_mask = [f'all_PoS_value_{year}.tif' for year in range(start_year, end_year + 1)]
