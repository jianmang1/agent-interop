...
# 添加标签和标题
ax.set_xlabel('时期', fontsize=20)
ax.set_ylabel('DOY', fontsize=20)
...
custom_lines = handles + [
    plt.Line2D([0], [0], color='w', marker='o', markersize=24, markerfacecolor='gray', label='草本'),
    plt.Line2D([0], [0], color='w', marker='^', markersize=24, markerfacecolor='gray', label='灌木'),
