...
# 定义路径
RASTER_DIR = Path(r'D:\MODIS43A4_2024\masked_without_tibet\LOS')
...
RASTER_FILES = {
    'mean_values.tif': {'vmin': 60, 'vmax': 300},
    'std_values.tif': {'vmin': 0, 'vmax': 50},
...
for raster_file, params in RASTER_FILES.items():
    ...
    xlabel = {'mean_values.tif': 'Mean LOS (DOY)',
              'std_values.tif': 'Std Values',
              'slope_values.tif': 'LOS trend (Days/year)',
