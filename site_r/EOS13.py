...
# --- 配置 ---
# 读取CSV数据
df = pd.read_csv('F:\\pythonforR\\EoS_yanzhen2\\eos_nosjm_500.csv')
...
for batch in range(total_batches):
    ...
    # --- 保存图像 ---
    output_filename = f'F:\\pythonforR\\EoS_yanzhen2\\EOS_scatter_plots_withoutsjm_batch_500_{batch + 1}.png'
