...
RASTER_FILES = {
    ...
    'masked2_SOS_MCD12Q2_2023.tif': {'vmin': 0, 'vmax': 360},
    'masked2_POS_MCD12Q2_2023.tif': {'vmin': 0, 'vmax': 360},
    'masked2_EOS_MCD12Q2_2023.tif': {'vmin': 0, 'vmax': 360},
}
...
def setup_map(ax, bounds, china_shapefile):
    ...
    # 设置地图范围
    ax.set_extent([bounds.left, bounds.right, bounds.bottom, bounds.top], crs=ccrs.PlateCarree()) # 修改了这里的'crsr'为'crs'

    # 注释掉或移除与添加其他底图元素和经纬度网格线相关的代码
