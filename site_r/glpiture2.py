...
# 读取数据
df = pd.read_csv('F:\pythonforR\SOS1\sos_withoutsjm.csv')
...
BIOINDIX  = ['doublelogisticthreshold_NDGI',  'doublelogisticthreshold_EVI', 'doublelogisticthreshold_NDPI', 'doublelogisticthreshold_NDVI', 'doublelogisticthreshold_DVI']
doubSoS_thresholds = [
...
for stage in acture3:
    for threshold in filterdayeos_thresholds:
